...
//             className="cursor-pointer pl-10 pr-4 py-2.5 bg-slate-800/50 border border-slate-600 rounded-lg text-white text-sm focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all hover:border-slate-500 font-[nunito]"
//           />
//         </div>
...
//                     <tr
//                       key={user.id}
//                       className={`border-b border-slate-700 hover:bg-slate-700/50 transition-all duration-200 group ${index === sortedUsers.length - 1 ? 'border-b-0' : ''
//                         }`}
//                     >
//                       <td className="px-4 sm:px-6 py-4">
//                         <div className="flex items-center gap-3 min-w-0">
//                           <div className="w-9 h-9 bg-linear-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center text-white font-bold text-sm shrink-0 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
...
//         {/* Table Footer */}
//         <div className="px-4 sm:px-6 py-4 bg-slate-800/50 border-t border-slate-700 flex items-center justify-between text-xs sm:text-sm text-slate-400 font-[nunito]">
//           <span>Showing <span className="text-white font-bold">{sortedUsers.length}</span> of <span className="text-white font-bold">{users.length}</span> users</span>
//           <button className="text-purple-400 hover:text-purple-300 font-semibold transition-colors cursor-pointer flex items-center gap-1">
