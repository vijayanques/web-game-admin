        ...
        <div className="overflow-y-auto h-[calc(100%-80px)]">
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-7 gap-2 max-h-64 overflow-y-auto p-2 bg-slate-800/30 rounded-lg border border-slate-700">
              ...
              <p className="text-xs text-slate-500 mt-2">Selected: <span className="text-purple-400 font-semibold">{formData.icon}</span></p>
            </div>
            ...
            <div className="flex gap-3 pt-4 border-t border-slate-700">
              ...
              <button
                ...
                className={` cursor-pointer flex-1 px-4 py-2.5 bg-linear-to-r from-purple-600 to-pink-600 text-white font-semibold text-sm rounded-lg transition-all duration-200 ${
