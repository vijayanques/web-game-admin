        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <main className="flex-1 overflow-auto">
            <div className="lg:hidden bg-slate-900 border-b border-slate-800 px-4 py-3 flex items-center justify-between sticky top-0 z-30">
              ...
              <h1 className="text-lg font-bold text-white font-[nunito]">Settings</h1>
              <div className="w-10" />
            </div>
            ...
            <div className="p-6">
              <div className="max-w-7xl mx-auto space-y-8 p-4 sm:p-6 lg:p-8">
                <div>
                  <h1 className="text-2xl font-bold text-white mb-2 font-[nunito]">Settings</h1>
                  <p className="text-slate-400 font-[nunito]">
                    Manage site branding and configuration
                  </p>
                </div>
